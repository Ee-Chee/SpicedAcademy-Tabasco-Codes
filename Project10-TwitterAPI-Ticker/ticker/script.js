//This js file is invoked and AJAX will further make a request to server(which is index.js) with url: "data.json"
//Requesting a json file from the server. So that the data inside json is displayed in ticker project.

$.ajax({
    url: "data.json", //object and array are typeof object
